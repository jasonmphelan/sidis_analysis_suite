...
inFile_names = ['../histograms/analysis_note/kinematics_data_10.4.root', '../histograms/analysis_note/kinematics_kaons_10.2.root', '../histograms/analysis_note/kinematics_data_10.4_beta_cut.root', '../histograms/analysis_note/kinematics_kaons_10.2_beta_cut.root']
...
for key in inFile[0].keys():
	...
	if isinstance( inFile[0][key], uproot.models.TH.Model_TH1F_v3): 
		...
		for i in range(len(inFile)):
			...
			ratio_pip = values_pip[i]/values_pip[0]
			ratio_pim = values_pim[i]/values_pim[0]
			...
			if i > 0:
				...
				ax[1, 0].set_ylabel(r'Ratio', fontsize=16)		
			...
			if i > 0:
				...
				ax[1, 1].set_ylabel(r'Ratio', fontsize=16)		
			#setTitle1D( fig, key )
