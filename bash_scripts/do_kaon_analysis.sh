...
#./../build/kaonAnalysis/makeKaonPlots ../histograms/analysis_note/k2pi_plots_match_RICH.root 1 2 1.25 &
#./../build/kaonAnalysis/makeKaonPlots ../histograms/analysis_note/pi2k_plots_match_RICH.root 0 2 1.25 &

./../build/kaonAnalysis/makeKaonPlots ../histograms/analysis_note/k2pi_plots_no_match.root 1 0 1.25 &
./../build/kaonAnalysis/makeKaonPlots ../histograms/analysis_note/pi2k_plots_no_match.root 0 0 1.25 &

#./../build/kaonAnalysis/makeKaonPlots ../histograms/analysis_note/k2pi_plots.root 1 1 1.25 &
#./../build/kaonAnalysis/makeKaonPlots ../histograms/analysis_note/pi2k_plots.root 0 1 1.25 &

#./../build/kaonAnalysis/makeKaonPlots ../histograms/analysis_note/k2pi_plots_rga.root 1 1 1.25 1 &
#./../build/kaonAnalysis/makeKaonPlots ../histograms/analysis_note/pi2k_plots_rga.root 0 1 1.25 1 &

wait

#./../../build/kaonAnalysis/calcKaonCorr ../histograms/analysis_note/k2pi_plots_rga.root ../data/correctionFiles/corrections_k2pi_rga.root ../histograms/analysis_note/k2pi_fits_rga.root 2.5
...
#./../../build/kaonAnalysis/calcKaonCorr ../histograms/analysis_note/pi2k_plots_rga.root ../data/correctionFiles/corrections_pi2k_rga.root ../histograms/analysis_note/pi2k_fits_rga.root 2.5
...
python ../plotting/plotCutFits.py ../histograms/analysis_note/k2pi_plots_no_match.root ../plotting/analysis_note/k2pi_fits_no_match
python ../plotting/plotCorrections.py corrections_k2pi_AN_no_match.root k2pi
...
python ../plotting/plotCutFits.py ../histograms/analysis_note/pi2k_plots_no_match.root ../plotting/analysis_note/analysis_note/pi2k_fits_no_match
python ../plotting/plotCorrections.py corrections_pi2k_AN_no_match.root pi2k

./../build/kaonAnalysis/calcKaonCorr ../histograms/analysis_note/k2pi_plots_match_RICH.root ../data/correctionFiles/corrections_k2pi_AN_match_RICH.root ../histograms/analysis_note/k2pi_fits_no_match.root 2.5
#python ../plotting/plotCutFits.py ../histograms/analysis_note/k2pi_plots.root /volatile/clas12/users/jphelan/SIDIS/analysis_note/k2pi_fits_no_match
#python ../plotting/plotCorrections.py corrections_k2pi_AN_no_match.root k2pi

./../build/kaonAnalysis/calcKaonCorr ../histograms/analysis_note/pi2k_plots_match_RICH.root ../data/correctionFiles/corrections_pi2k_AN_match_RICH.root ../histograms/analysis_note/pi2k_fits_no_match.root 2.5
...
#./../build/kaonAnalysis/kaonSys ../data/correctionFiles/corrections_pi2k_AN_no_match
#./../build/kaonAnalysis/kaonSys ../data/correctionFiles/corrections_k2pi_AN_no_match
