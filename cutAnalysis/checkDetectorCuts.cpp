...
int main( int argc, char** argv){
	...
	if( argc < 4 ){
		...
		cerr << "./code [outFile name (no extension)] [Beam energy (0 for all energies)] [Target]\n";
	...
	////////////////////////////////////Begin file loop////////////////////////////////////////////////////
		...
		int NeventsTotal = c12.getReader().getEntries();       
			...
			for(int i = 0; i < Npi; i++){
				...
				/*
				if( pi_dummy.getEdge(0) < 0 || pi_dummy.getEdge(1) < 0 || pi_dummy.getEdge(2) < 0 ){ 
					cout<<"Found negative edge"<<std::endl;
					cout<<"Edge 1 : "<<pi_dummy.getEdge(0)<<std::endl;
					cout<<"X1 : "<<pi_dummy.getDC_x1()<<" && Y1 : "<<pi_dummy.getDC_y1()<<std::endl;
					cout<<"Edge 2 : "<<pi_dummy.getEdge(1)<<std::endl;
					cout<<"Edge 3 : "<<pi_dummy.getEdge(2)<<std::endl;
				}
				*/				
